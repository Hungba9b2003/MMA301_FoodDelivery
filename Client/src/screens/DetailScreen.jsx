...
function DetailScreen({ navigation, route }) {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://rich-blue-shrimp-wig.cyclic.app/recipe/detail/${currentSlug}`,
        {
          headers: headers,
        }
      )
                ...
                <TouchableOpacity onPress={handleSaveButton}>
                  <View
                    style={[
                      styles.actContainer,
                      ,
                      { backgroundColor: saved ? "#EEC302" : "white" },
                    ]}
                  >
                    <Icon
                      name="save"
                      size={20}
                      color={saved ? "white" : "#EEC302"}
                    />
                  </View>
                </TouchableOpacity>
                <TouchableOpacity onPress={handleLikeButton}>
                  <View
                    style={[
                      styles.actContainer,
                      ,
                      { backgroundColor: liked ? "#EEC302" : "white" },
                    ]}
                  >
                    <Icon
                      name="hearto"
                      size={20}
                      color={liked ? "white" : "#EEC302"}
          ...
          <ScrollView>
            ...
            {type === "ingredients" ? (
              ...
              <>
                ...
                {
                  <TouchableOpacity
                    onPress={() => Linking.openURL(recipe.video_link)}
                  >
                    <View
                      style={{
                        flexDirection: "row",
